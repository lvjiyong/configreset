...
from configreset.log import logger
...
class ConfTestCase(unittest.TestCase):
    ...
    def test_reset(self):
        c = conf.load_package('etc', package='etc', exclude=['etc.settings_conf'])
        conf.reset('target_conf', c)
        import target_conf
    ...
    def test_load_package(self):
        c = conf.load_package('etc', 'etc', exclude=['etc'])
    ...
    def test_config(self):
        ...
        c = conf.load_from_ini(conf_name)
        s = conf.config(c)
